...
TEST_CASE("Read input registers", "[FC04]") {
  ...
  uint8_t stdErrorResponse[] = {0x11, 0x84, 0x02, 0xC3, 0x04};  // Error response with correct CRC
...
TEST_CASE("Write multiple holding registers", "[FC16]") {
  ...
  uint8_t stdErrorResponse[] = {0x11, 0x90, 0x02, 0xCC, 0x04};  // Error response with correct CRC
